...
import com.example.matechatting.utils.CropViewUtils;
...
public class CropView extends View {
    ...
    public CropView setBgColor(int bgColor) {
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.CropView_bgColor, Color.WHITE);
